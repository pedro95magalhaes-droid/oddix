...
const styles: Record<string, CSSProperties> = {
  ...
  headerLogo: { maxWidth: 190, maxHeight: 44, objectFit: "contain" },
  ...
  heroText: { maxWidth: 580, margin: 0, color: "rgba(255,255,255,.94)", fontSize: 18, lineHeight: 1.38, fontWeight: 800 },
  heroFeatures: { display: "flex", flexWrap: "wrap", gap: 10, marginTop: 24, fontWeight: 900, color: "rgba(255,255,255,.92)" },
  ...
  topPickCard: {
    ...
    padding: 22,
    display: "grid",
    gridTemplateColumns: "170px 430px minmax(360px, 1fr) auto",
    gap: 22,
    alignItems: "center",
  },
