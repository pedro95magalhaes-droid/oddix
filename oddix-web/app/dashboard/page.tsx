...
const FALLBACK_PLAYER = "/images/oddix-player.png";
  ...
  return (
    <article style={styles.propMiniCard}>
      ...
      <div style={styles.propContent}>
        ...
        <button style={styles.propButton} onClick={onOpen}>{locked ? "DESBLOQUEAR" : "PEGAR PALPITE"}</button>
      </div>
    </article>
  );
}
