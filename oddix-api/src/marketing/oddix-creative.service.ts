...
export class OddixCreativeService {
  ...
  private visualPrompt(theme: OddixCreativeTheme, input: OddixCreativeInput) {
    ...
    const themePrompt: Record<OddixCreativeTheme, string[]> = {
      ...
      VIP_CHAMPIONS: ['champions league style', 'blue gold lights', 'epic stadium'],
      ...
      VIP_GAMER: ['esports football style', 'neon green purple', 'gamer energy'],
    };

    return [...base, ...themePrompt[theme], input.league || 'football match'].join(', ');
  }
